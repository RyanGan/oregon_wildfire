...
cumulative <- distributed_lag(hf65, pm_df = 2, temp_df = 2, cumulative = T)
cumulative
...
check <- mi65 %>% filter(personkey == 1782923) %>% 
  select(personkey, outcome, dx1, date, fromdate)

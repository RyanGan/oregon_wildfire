...
```{r category, echo = F, message = F, warning = F, results='asis', eval=FALSE}
read_path <- paste0("../data_new/medication/oregon_beta_ndc_index_full.csv")
inhaler_ndc <- read_csv(read_path)

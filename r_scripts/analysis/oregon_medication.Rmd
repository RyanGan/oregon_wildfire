...
**3.Methods: **
use case-crossover for all health outcome figures and results. Make sure smoke is assigned via zipcode. For the descriptive of smoke, I think the county-level for now. We may move to zip.

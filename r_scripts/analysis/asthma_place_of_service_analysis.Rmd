...
results <- bind_rows(sameday_result, sex_result, age_results) %>% 
  ...
  filter(service_place %in% c("SABA Fill", "Office", "Urgent Care",
...
plot <- ggplot(results, aes(x = strata, y = odds_ratio)) +
  geom_point(color = "#7f00ff") + 
  geom_errorbar(aes(ymin=lower95, ymax=upper95), color = "#7f00ff",width = 0.2) +
  geom_hline(yintercept = 1, linetype=2) +
  facet_wrap(~service_place) +
...
#ggsave("./Figs/total_pos_results_plot.tiff", total_plot, 

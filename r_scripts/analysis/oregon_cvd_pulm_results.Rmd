...
sameday_results_f <- outcome_df_list %>% 
  ...
  # preserve order of names
  mutate(outcome_names = parse_factor(outcome_names, levels = outcome))
...
### 7.b Age
*Jingyang to complete using function*
Color palette to use for the 3 age categories. c("#899DA4", "#35274A" "#F2300F").

##8. SABA same-day results by underlying respiratory diagnosis
*Jingyang to complete using function*
Color palette to use for the 4 age categories.
c("#E2D200" "#46ACC8" "#E58601" "#B40F20")

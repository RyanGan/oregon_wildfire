...
## Steps of calculating the proportion of a specific zip code polygon and WRF Grid.
1. Choose zip code = 94705. WRF Grid = 261 and 262. (6 WRF Grid in total. Only 
two are chosen for test)
...
summary(test_grid) # 6 grids over the zip code
test_grid2 <- test_grid %>% filter(!is.na(ZCTA5CE10))
test_grid2
```


2. Show the actual location in the map.
```{r}
...
<ul class="incremental"> 
  ...
  <br/> When analyzing big data set (like millions of observations), it is 
  unrealistic to copy so many rows of similar or same code.</li><br/>
  <li> And... <br/> Why using apply function? </li>
  <li> Code Readability <br/>  Understand the purporse more directly.</li> 
  <li> Working Efficiency <br/>  When analyzing big data set (like millions of 
  observations), it is unrealistic to copy so many rows of similar or same code.</li> 
</ul> 

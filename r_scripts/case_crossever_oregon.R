# ------------------------------------------------------------------------------
# Title: Case crossover for diseases of Oregon State (Practice)
# Author: Jingyang Liu
...
library(lubridate)
getwd()
read_path <- paste0('./data1/or_hosp_w_outcome_df.csv')
...
for(m in var_list){ # begin first loop of variable names (outcomes)
  ...
  write_csv(outcome_casecross, paste0("./data1/case_cross_data/", file_name))
